...
addResourcePath('highcharts','www/highchartsb/')
...
#annotGeneLoc <- list(Indica=read.csv("./mergedTAIR10Annotations.modifiedForBrowser.csv",sep=",",head=TRUE,stringsAsFactors = FALSE),
           #        Japonica=read.csv("./mergedTAIR10Annotations.modifiedForBrowser.csv",sep=",",head=TRUE,stringsAsFactors=FALSE))
